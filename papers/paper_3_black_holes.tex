...
\section{Simulation}
We simulated the trajectory of an infalling observer ("Alice") using our `black_hole.py` engine. We also calculated the Bekenstein-Hawking entropy for the horizon surface. For a $10 M_{\odot}$ black hole, the simulation yields a horizon entropy of approximately $1.51 \times 10^{79}$ bits.
...
\end{equation}
We propose that the "Solid State" horizon saturates this bound, behaving as a **Perfect Quantum Fluid**.

...
\begin{figure}[h]
    ...
    \caption{Forecast for Gravitational Wave Luminosity Distance. The Blue line is the Machian prediction ($D_L^{GW} < D_L^{EM}$), while the Red dashed line is standard $\Lambda$CDM. The error bars represent simulated LISA data. The separation between models exceeds $50\sigma$ at $z=2$, providing a definitive test.}
    \label{fig:gw}
\end{figure}
...
Belgacem, E., Dirian, Y., Foffa, S., \& Maggiore, M. (2018). Modified gravitational-wave propagation and standard sirens. \textit{Phys. Rev. D}, 98, 023510.

\bibitem{Steinhardt2016}
Steinhardt, C. L., Capak, P., Masters, D., \& Speagle, J. S. (2016). The impossibly early galaxy problem. \textit{Astrophys. J.}, 824, 21.

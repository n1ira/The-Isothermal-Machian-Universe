...
\begin{figure}[h]
    ...
    \caption{Lookback Time vs Redshift. The Blue line (Machian) shows a universe that is consistently older than the Standard Model (Red dashed), especially at high redshifts.}
    \label{fig:age}
\end{figure}

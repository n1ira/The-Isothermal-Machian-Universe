...
import { Activity, Disc, Eye, Globe, Layers, Scale, Sparkles } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-gray-200 font-sans selection:bg-cyan-500/30">
      ...
      <main className="max-w-[1800px] mx-auto px-4 pb-20 grid grid-cols-1 md:grid-cols-12 gap-6">
        ...
        <div className="col-span-1 md:col-span-6 bg-gradient-to-br from-purple-900/20 to-transparent p-6 rounded-2xl border border-purple-500/30 hover:border-purple-400 transition-colors group relative overflow-hidden">
          <div className="absolute top-0 right-0 p-4 opacity-20">
            <Activity size={64} />
          </div>
          <div className="flex items-center gap-3 mb-4 text-white">
            <Sparkles size={24} className="text-yellow-400" />
            <h2 className="text-lg font-bold tracking-widest uppercase text-white">The Smoking Gun Prediction</h2>
          </div>

          <h3 className="text-2xl font-bold text-purple-400 mb-2">Gravitational Wave Brightness</h3>
          <p className="text-gray-300 mb-4 max-w-xl">
            A definitive test for LISA. In General Relativity, Gravity and Light fade at the same rate. In the IMU, Gravity fades <i>slower</i> due to the evolving mass scale.
          </p>

          <div className="grid grid-cols-2 gap-8 mt-6">
            <div className="text-center">
              <div className="text-xs text-gray-500 uppercase tracking-widest mb-1">Standard Model (ΛCDM)</div>
              <div className="text-xl font-mono text-gray-400">Equal Brightness</div>
              <div className="text-xs text-gray-500 mt-1"><Latex>{'$D_L^{GW} = D_L^{EM}$'}</Latex></div>
            </div>
            <div className="text-center relative">
              <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-purple-500 text-white text-[10px] font-bold px-2 py-0.5 rounded-full">
                PREDICTION
              </div>
              <div className="text-xs text-purple-400 uppercase tracking-widest mb-1">Isothermal Machian</div>
              <div className="text-xl font-mono text-white">GWs are Brighter</div>
              <div className="text-xs text-purple-300 mt-1"><Latex>{'$D_L^{GW} = D_L^{EM} / (1+z)$'}</Latex></div>
            </div>
          </div>
        </div>
            ...
            <table className="w-full text-left border-collapse">
              ...
              <tbody className="text-sm text-gray-300">
                ...
                <tr className="border-b border-white/5 hover:bg-white/5 transition-colors">
                  ...
                  <td className="p-4 text-cyan-100">Universal Conformal Coupling modifies geometry</td>
                </tr>
                <tr className="border-b border-white/5 hover:bg-white/5 transition-colors">
